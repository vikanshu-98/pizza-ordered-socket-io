...
function initAdmin(socket, setLimitCharacter) {
  ...
  function _getInitialData() {
    _getInitialData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data;
  ...
  function generateMarkup(orderData) {
    ...
    orderData.forEach(function (element, index) {
      var innercount = 0;
      string = "\n        <tr>\n            <td class=\" px-4 py-2  border border-white\">".concat(++count, " </td>\n            <td class=\" py-2  border border-white\">\n                <table class=\"w-full border border-black-400\">\n                    <thead>\n                        <tr class=\" font-bold  text-left\">\n                            <th class=\"px-4 py-2 border border-black-400\">Order Id</th>\n                            <th class=\"px-4 py-2 border border-black-400\">Name - Quantity</th> \n                        </tr>\n                    </thead>\n                    <tbody>\n                        <tr>\n                            <td class=\"px-4 py-2 border border-black-400\"><abbr title=").concat(element._id, "\n                                    class=\"no-underline limit-length text-[#b23301]\">").concat(element._id, "</abbr></td>\n                            <td class=\"px-4 py-2 border border-black-400\">");
      Object.values(element.orders).forEach(function (elem1) {
        string += "".concat(++innercount, ". ").concat(elem1.item.name, " - ").concat(elem1.qty, " <br>");
      });
      string += "</td>\n                        </tr>\n                    </tbody>\n                </table>\n\n            </td>\n            <td class=\" py-2  border border-white\">\n                <table class=\"w-full border border-black-400\">\n                    <thead>\n                        <tr class=\" font-bold  text-left\">\n                            <th class=\"px-4 py-2 border border-black-400\">Name</th>\n                            <th class=\"px-4 py-2 border border-black-400\">Email</th>\n                            <th class=\"px-4 py-2 border border-black-400\">Address</th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <tr>\n                            <td class=\"px-4 py-2 border border-black-400\">".concat(element.customerId.name, "</td>\n                            <td class=\"px-4 py-2 border border-black-400\"> <abbr\n                                    title=\"").concat(element.customerId.email, "\"\n                                    class=\"no-underline limit-length\">").concat(element.customerId.email, "</abbr></td>\n                            <td class=\"px-4 py-2 border border-black-400\">").concat(element.address, "</td>\n                        </tr>\n                    </tbody>\n                </table>\n\n            </td>\n            <td class=\" px-4 py-2  border border-white\">\n                 <div class=\"inline-block relative w-[10rem]\">\n                <form actio=\"/admin/order/status\" method=\"POST\">\n                    <input type=\"hidden\" name=\"orderId\" value=\"").concat(element._id, "\"/>\n                    <select name=\"status\" onchange=\"this.form.submit()\" class=\"cursor-pointer font-bold block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline\">\n                        <option value=\"1\" ").concat(getSelectedStatus(element.orderStatus, 1), ">").concat(getStatusText(1), "</option>\n                        <option value=\"2\" ").concat(getSelectedStatus(element.orderStatus, 2), ">").concat(getStatusText(2), "</option>\n                        <option value=\"3\" ").concat(getSelectedStatus(element.orderStatus, 3), ">").concat(getStatusText(3), "</option>\n                        <option value=\"4\" ").concat(getSelectedStatus(element.orderStatus, 4), ">").concat(getStatusText(4), "</option>\n                        <option value=\"5\" ").concat(getSelectedStatus(element.orderStatus, 5), ">").concat(getStatusText(5), "</option>\n                        <option value=\"6\" ").concat(getSelectedStatus(element.orderStatus, 6), ">").concat(getStatusText(6), "</option>\n                    </select>\n                </form>\n                <div class=\"pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700\">\n                    <svg class=\"fill-current h-4 w-4\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 20 20\">\n                        <path d=\"M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.348 8z\"/>\n                    </svg>\n                </div>\n            </div>\n            </td>\n            <td class=\" px-4 py-2  border border-white\">").concat(moment__WEBPACK_IMPORTED_MODULE_0___default()(element.createdAt).format('MMMM D,YYYY h:mm A'), "</td>\n        </tr>");
      markup[index] = string;
    });
    return markup;
  }
  function getSelectedStatus(status, index) {
    ...
    var index1 = status == 'delivered' ? statusObj[status] : statusObj[status];
    switch (index) {
      case 1:
...
var successRegistered = document.getElementById('successRegistered');
...
var allAddToCart = document.querySelectorAll('.add-to-cart');
allAddToCart.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var data = JSON.parse(btn.dataset.pizzaDetails);
    updateCart(data);
  });
});
...
var blinkerCurrentStatus = function blinkerCurrentStatus() {
  var blink = document.getElementById('statusBlink');
  if (blink) {
    if (!blink.style.backgroundColor) {
      blink.style.backgroundColor = 'white';
    } else {
      var rgbString = blink.style.backgroundColor;
      if (rgbString == 'white') blink.style.backgroundColor = 'green';else {
        blink.style.backgroundColor = 'white';
      }
    }
  }
...
var updateStatus = function updateStatus(order) {
  ...
  status.forEach(function (elem) {
    ...
    if (elem.dataset.status == order.orderStatus) {
      stepCompleted = false;
      var day1 = moment(order.updatedAt).format('ddd,MMM DD');
      var day2 = moment(order.updatedAt).format(' hh:mm A');
...
var setLimitCharacter = function setLimitCharacter() {
  ...
  allDataThatToBeLimit.forEach(function (elem) {
    elem.innerText = "".concat(elem.innerText.substr(0, 10), "...");
  });
};
var callAllFun = function callAllFun() {
  setLimitCharacter();
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtimeproject"] = self["webpackChunkrealtimeproject"] || [];
